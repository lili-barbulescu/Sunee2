...
- pin_list:
  ...
  - {pin_num: '4', peripheral: SUPPLY, signal: 'VSS, 0', pin_signal: VSS}
  ...
  - {pin_num: '8', peripheral: GPIOA, signal: 'GPIO, 6', pin_signal: PTA6/TPM0_CH0/SPI0_MISO}
  ...
  - {pin_num: '12', peripheral: I2C0, signal: SCL, pin_signal: ADC0_SE9/PTB0/IRQ_5/LLWU_P4/EXTRG_IN/SPI0_SCK/I2C0_SCL}
  - {pin_num: '13', peripheral: I2C0, signal: SDA, pin_signal: ADC0_SE8/CMP0_IN3/PTB1/IRQ_6/LPUART0_TX/LPUART0_RX/I2C0_SDA}
  - {pin_num: '14', peripheral: GPIOB, signal: 'GPIO, 2', pin_signal: VREF_OUT/CMP0_IN5/PTB2/IRQ_7/LPUART0_RX/LPUART0_TX}
  - {pin_num: '15', peripheral: GPIOA, signal: 'GPIO, 8', pin_signal: ADC0_SE3/PTA8/I2C0_SCL/SPI0_MOSI}
  - {pin_num: '16', peripheral: GPIOA, signal: 'GPIO, 9', pin_signal: ADC0_SE2/PTA9/I2C0_SDA/SPI0_SCK}
  - {pin_num: '17', peripheral: LPUART0, signal: TX, pin_signal: PTB3/IRQ_10/I2C0_SCL/LPUART0_TX}
  - {pin_num: '18', peripheral: LPUART0, signal: RX, pin_signal: PTB4/IRQ_11/I2C0_SDA/LPUART0_RX}
...
void BOARD_InitPins(void) {
  ...
  CLOCK_EnableClock(kCLOCK_PortB);                           /* Port B Clock Gate Control: Clock enabled */
  	...
  	PORT_SetPinMux(PORTA, PIN0_IDX, kPORT_MuxAlt3);            /* PORTA0 (pin 22) is configured as SWD_CLK */
    ...
    PORT_SetPinMux(PORTA, PIN2_IDX, kPORT_MuxAlt3);            /* PORTA2 (pin 24) is configured as SWD_DIO */
    ...
    PORT_SetPinMux(PORTA, PIN6_IDX, kPORT_MuxAsGpio);          /* PORTA6 (pin 8) is configured as PTA6 */
    PORT_SetPinMux(PORTA, PIN7_IDX, kPORT_MuxAsGpio);          /* PORTA7 (pin 11) is configured as PTA7 */
    PORT_SetPinMux(PORTA, PIN8_IDX, kPORT_MuxAsGpio);          /* PORTA8 (pin 15) is configured as PTA8 */
    PORT_SetPinMux(PORTA, PIN9_IDX, kPORT_MuxAsGpio);          /* PORTA9 (pin 16) is configured as PTA9 */
    PORT_SetPinMux(PORTB, PIN0_IDX, kPORT_MuxAlt4);            /* PORTB0 (pin 12) is configured as I2C0_SCL */
    PORT_SetPinMux(PORTB, PIN1_IDX, kPORT_MuxAlt4);            /* PORTB1 (pin 13) is configured as I2C0_SDA */
    ...
    PORT_SetPinMux(PORTB, PIN2_IDX, kPORT_MuxAsGpio);          /* PORTB2 (pin 14) is configured as PTB2 */
    PORT_SetPinMux(PORTB, PIN3_IDX, kPORT_MuxAlt3);            /* PORTB3 (pin 17) is configured as LPUART0_TX */
    PORT_SetPinMux(PORTB, PIN4_IDX, kPORT_MuxAlt3);            /* PORTB4 (pin 18) is configured as LPUART0_RX */
